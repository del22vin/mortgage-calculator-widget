...
(function ($) {
    ...
    $.fn.HousingLoanCalculator = function (options) {
        ...
        head = '<div id="C88ECMHousingLoanCalcuContainer"><div class="loanCalculatorMainContent"><div class="top"><div class="topLeft"> &nbsp;</div> <div class="topCenter"><div> <label id="LoanCalculatorHeaderName" class="loanCalculatortitle">' + settings.title + '</label></div> </div><div class="topRight"> &nbsp;</div> </div><div class="middle"> <div class="middleLeft">&nbsp;</div><div class="middleCenter"><div id="LoanCalculatorIcon" class="objectIcon"></div><div id="LoanCalculatorTitle" class="objectTitle">Housing Loan Calculator</div><div id="LoanCalculatorDescription" class="objectDescription">loan Calculator................</div>';
